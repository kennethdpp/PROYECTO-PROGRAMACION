...
#print(valint(4,(4,10))) #dos argumentos y el segundo no es de tipo esperado, en este caso una lista (quitar el "#")
print(valint(4,[3,9])) #dos argumentos, el segundo es de tipo esperado y creciente, y el primero se encuentra en el intervalo del segundo
#print(valint(4,[10,4])) #dos argumentos, pero el segundo no es una lista creciente (quitar el "#")
#print(valint(4,5)) #dos argumentos y el segundo no es del tipo esperado (quitar el "#")
#print(valint(4,[1,"a"])) #un elemento de la lista no es un entero (quitar el "#")
...
#print(valfloat(4.0,"a")) #dos argumentos y el segundo no es de tipo esperado, en este caso lista o tupla (quitar el "#")
print(valfloat(4.0,[3.99,9])) #dos argumentos, el segundo es de tipo esperado y creciente, y el primero se encuentra en el intervalo del segundo
print(valfloat(4.0,(1,5.6))) #mismo caso pero con una tupla
#print(valfloat(4.0,[6,3.8])) #dos argumentos, pero el segundo no es una lista o tupla creciente (quitar el "#")
#print(valfloat(4.0,[1,"a"])) #un elemento de la lista no es un numero (quitar el "#")
...
#print(valcomplex(3+4j,(5,10))) #dos argumentos y el segundo no es de tipo esperado, en este caso lista (quitar el "#")
print(valcomplex(3+4j,[4,10])) #dos argumentos, el segundo es de tipo esperado y el modulo del primero se encuentra en el intervalo del segundo
#print(valcomplex(3+4j,[10,4])) #dos argumentos, pero el segundo no es una lista creciente (quitar el "#")
#print(valcomplex(3+4j,[4,"a"])) #un elemento de la lista no es un numero (quitar el "#")
